  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#36393f] flex items-center justify-center p-4">
        <div className="w-full max-w-sm bg-[#2f3136] rounded-lg p-8 border border-gray-700 shadow-xl text-center">
    ...
    <div className="min-h-screen bg-[#36393f] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-[#2f3136] rounded-lg p-8 border border-gray-700 shadow-xl">
          <h2 className="text-xl font-bold text-white mb-6 text-center">Create an account</h2>
